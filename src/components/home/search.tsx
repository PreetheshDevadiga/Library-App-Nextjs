...
export function SearchBar() {
  ...
  const disableSearch = pathname.includes("/transaction") || pathname.includes('/Professors') || pathname.includes('/allAppointments') || pathname.includes('/viewprofile') || pathname.includes('/editprofile');
  return (
